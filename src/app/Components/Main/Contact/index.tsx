...
const Contact = () => {
  ...
  const client = new Client()
    ...
    .setProject('65b1607634712af6ba09');
    ...
    <div>
      ...
      <div className="w-[90%] text-[#FAFAFA] bg-[#232325] mx-auto my-[4vh] md:my-[9vh] rounded-md py-4 px-4 md:px-10 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] border-[#303030] border-[1px]">
        <div className="md:flex justify-between mx-auto">
          <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Your Name" type="text" name="name" className="bg-[#232325] border-b-2 my-4 border-[#383838] focus:outline-none" />
          <input value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Your Email" type="text" name="email" className="bg-[#232325] border-b-2 my-4 border-[#383838] focus:outline-none md:w-[40%]" />
        </div>
