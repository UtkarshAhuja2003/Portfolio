    ...
    <div className="md:pb-[6vh] pb-[2vh]">
      ...
      <div className="md:block flex w-[80%] justify-between md:w-full mx-auto">
        <div className="bg-[#383839] w-[30%] md:w-[65%] rounded-[10px] md:rounded-[35px] mx-auto md:mt-[7vh]">
          <Image src="/utkarsh.png" alt="Utkarsh Ahuja" width={200} height={200} />
        </div>
      ...
      <div className="w-[70%] flex justify-between mx-auto mt-[2vh] md:mt-[6vh] text-[#D6D6D6]">
        <a href="https://www.linkedin.com/in/ahuja-utkarsh" target="_blank" rel="noopener noreferrer"><IoLogoLinkedin size={20} /></a>
        <a href="https://github.com/UtkarshAhuja2003" target="_blank" rel="noopener noreferrer"><FaGithub size={20} /></a>
        <a href="https://leetcode.com/ahuja_utkarsh" target="_blank" rel="noopener noreferrer"><TbBrandLeetcode size={20} /></a>
        <a href="https://twitter.com/UtkarshAhuja03" target="_blank" rel="noopener noreferrer"><FaSquareXTwitter size={20} /></a>
        <a href="https://medium.com/@ahujautkarsh" target="_blank" rel="noopener noreferrer"><FaMedium size={20} /></a>
      </div>
      {
        showContact && <div>
          <Detail type="EMAIL" />
